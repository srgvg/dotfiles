...
hash /home/serge/.arkade/bin/kustomize >&/dev/null && complete -C /home/serge/.arkade/bin/kustomize completion bash
...
_kustomize_build()
{
    ...
    flags+=("--allow_id_changes")
    local_nonpersistent_flags+=("--allow_id_changes")
    flags+=("--enable-exec")
    local_nonpersistent_flags+=("--enable-exec")
    flags+=("--enable-star")
    local_nonpersistent_flags+=("--enable-star")
    flags+=("--enable_alpha_plugins")
    local_nonpersistent_flags+=("--enable_alpha_plugins")
    flags+=("--enable_managedby_label")
    local_nonpersistent_flags+=("--enable_managedby_label")
    flags+=("--env=")
    two_word_flags+=("--env")
    two_word_flags+=("-e")
    local_nonpersistent_flags+=("--env=")
    flags+=("--load_restrictor=")
    two_word_flags+=("--load_restrictor")
    local_nonpersistent_flags+=("--load_restrictor=")
    flags+=("--mount=")
...
{
    last_command="kustomize_cfg_annotate"
...
{
    last_command="kustomize_cfg_create-setter"
    ...
    local_nonpersistent_flags+=("--schema-path=")
    flags+=("--set-by=")
    two_word_flags+=("--set-by")
    local_nonpersistent_flags+=("--set-by=")
    flags+=("--type=")
    two_word_flags+=("--type")
...
{
    last_command="kustomize_cfg_create-subst"
    ...
    local_nonpersistent_flags+=("--field=")
    flags+=("--field-value=")
    two_word_flags+=("--field-value")
    local_nonpersistent_flags+=("--field-value=")
    flags+=("--pattern=")
    ...
    must_have_one_flag=()
    must_have_one_flag+=("--field-value=")
    must_have_one_flag+=("--pattern=")
    must_have_one_noun=()
    noun_aliases=()
}
...
_kustomize_cfg_fmt()
{
    last_command="kustomize_cfg_fmt"
    ...
    local_nonpersistent_flags+=("--recurse-subpackages")
    flags+=("--set-filenames")
    local_nonpersistent_flags+=("--set-filenames")
    flags+=("--use-schema")
    local_nonpersistent_flags+=("--use-schema")
    flags+=("--stack-trace")
...
_kustomize_cfg_init()
{
    last_command="kustomize_cfg_init"
...
{
    last_command="kustomize_cfg_list-setters"
    ...
    flags+=("--include-subst")
    local_nonpersistent_flags+=("--include-subst")
    flags+=("--markdown")
...
{
    last_command="kustomize_cfg_merge"
    ...
    flags+=("--invert-order")
    local_nonpersistent_flags+=("--invert-order")
    flags+=("--stack-trace")
...
{
    last_command="kustomize_cfg_merge3"
    ...
    flags+=("--ancestor=")
    two_word_flags+=("--ancestor")
    local_nonpersistent_flags+=("--ancestor=")
    flags+=("--from=")
    two_word_flags+=("--from")
    local_nonpersistent_flags+=("--from=")
    flags+=("--path-merge-key")
    local_nonpersistent_flags+=("--path-merge-key")
    flags+=("--to=")
    two_word_flags+=("--to")
...
_kustomize_cfg_set()
{
    last_command="kustomize_cfg_set"
...
_kustomize_cfg()
{
    ...
    commands+=("cat")
    commands+=("count")
    commands+=("create-setter")
    commands+=("create-subst")
    commands+=("fmt")
    commands+=("grep")
    commands+=("init")
    commands+=("list-setters")
    commands+=("merge")
    commands+=("merge3")
    commands+=("set")
    commands+=("tree")
