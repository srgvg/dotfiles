...
HOMETMPDIR="$(readlink --canonicalize-existing --no-newline $HOME/$HOMETMPDIRNAME)"
...
#LOCK_ANNOTATETEXT=
LOCK_DEFAULT_LOCKSCREEN="${BACKGROUND_PICTURES}/flock"
...
SETBG_LOOP_DELAY=${SETBG_LOOP_DELAY:-300}
