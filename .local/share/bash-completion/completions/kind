...
__kind_handle_go_custom_completion()
{
    ...
    # Calling ${words[0]} instead of directly kind allows handling aliases
    args=("${words[@]:1}")
    # Disable ActiveHelp which is not supported for bash completion v1
    requestComp="KIND_ACTIVE_HELP=0 ${words[0]} __completeNoDesc ${args[*]}"
...
_kind_completion_powershell()
{
    last_command="kind_completion_powershell"
