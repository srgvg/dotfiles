...
_eksctl_create_addon()
{
    ...
    two_word_flags+=("--namespace-config")
    local_nonpersistent_flags+=("--namespace-config")
    local_nonpersistent_flags+=("--namespace-config=")
    flags+=("--profile=")
    two_word_flags+=("--profile")
    two_word_flags+=("-p")
...
_eksctl_create_cluster()
{
    ...
    local_nonpersistent_flags+=("--enable-auto-mode")
    flags+=("--enable-node-repair")
    local_nonpersistent_flags+=("--enable-node-repair")
    flags+=("--enable-ssm")
    ...
    local_nonpersistent_flags+=("--instance-selector-memory=")
    flags+=("--instance-selector-neuron-devices=")
    two_word_flags+=("--instance-selector-neuron-devices")
    local_nonpersistent_flags+=("--instance-selector-neuron-devices")
    local_nonpersistent_flags+=("--instance-selector-neuron-devices=")
...
_eksctl_create_podidentityassociation()
{
    ...
    flags+=("--disable-session-tags")
    local_nonpersistent_flags+=("--disable-session-tags")
    flags+=("--namespace=")
    two_word_flags+=("--namespace")
    local_nonpersistent_flags+=("--namespace")
    local_nonpersistent_flags+=("--namespace=")
    ...
    local_nonpersistent_flags+=("--tags")
    local_nonpersistent_flags+=("--tags=")
    flags+=("--target-role-arn=")
    two_word_flags+=("--target-role-arn")
    local_nonpersistent_flags+=("--target-role-arn")
    local_nonpersistent_flags+=("--target-role-arn=")
    flags+=("--timeout=")
    two_word_flags+=("--timeout")
    local_nonpersistent_flags+=("--timeout")
...
_eksctl_update_auto-mode-config()
{
    last_command="eksctl_update_auto-mode-config"
    ...
    local_nonpersistent_flags+=("--config-file=")
    local_nonpersistent_flags+=("-f")
    flags+=("--drain-all-nodegroups")
    local_nonpersistent_flags+=("--drain-all-nodegroups")
    flags+=("--drain-parallel=")
    two_word_flags+=("--drain-parallel")
    local_nonpersistent_flags+=("--drain-parallel")
    local_nonpersistent_flags+=("--drain-parallel=")
    flags+=("--ignore-missing-subnets")
    local_nonpersistent_flags+=("--ignore-missing-subnets")
    flags+=("--profile=")
    two_word_flags+=("--profile")
    two_word_flags+=("-p")
    local_nonpersistent_flags+=("--profile")
...
_eksctl_update_podidentityassociation()
{
    ...
    local_nonpersistent_flags+=("--namespace")
    local_nonpersistent_flags+=("--namespace=")
    flags+=("--no-disable-session-tags")
    local_nonpersistent_flags+=("--no-disable-session-tags")
    flags+=("--profile=")
    two_word_flags+=("--profile")
    two_word_flags+=("-p")
    local_nonpersistent_flags+=("--profile")
...
_eksctl_utils_describe-cluster-versions()
{
    last_command="eksctl_utils_describe-cluster-versions"
    ...
    local_nonpersistent_flags+=("-c")
    flags+=("--cluster-types=")
    two_word_flags+=("--cluster-types")
    local_nonpersistent_flags+=("--cluster-types")
    local_nonpersistent_flags+=("--cluster-types=")
    flags+=("--cluster-versions=")
    two_word_flags+=("--cluster-versions")
    local_nonpersistent_flags+=("--cluster-versions")
    local_nonpersistent_flags+=("--cluster-versions=")
    flags+=("--config-file=")
    two_word_flags+=("--config-file")
    two_word_flags+=("-f")
    ...
    local_nonpersistent_flags+=("-f")
    flags+=("--default-only")
    local_nonpersistent_flags+=("--default-only")
    flags+=("--include-all")
    local_nonpersistent_flags+=("--include-all")
    flags+=("--profile=")
    two_word_flags+=("--profile")
    two_word_flags+=("-p")
    local_nonpersistent_flags+=("--profile")
...
_eksctl_utils_update-zonal-shift-config()
{
    last_command="eksctl_utils_update-zonal-shift-config"
    ...
    local_nonpersistent_flags+=("--config-file=")
    local_nonpersistent_flags+=("-f")
    flags+=("--enable-zonal-shift")
    local_nonpersistent_flags+=("--enable-zonal-shift")
    flags+=("--profile=")
    two_word_flags+=("--profile")
    two_word_flags+=("-p")
    local_nonpersistent_flags+=("--profile")
...
_eksctl_utils()
{
    ...
    commands+=("update-zonal-shift-config")
