        ...
        satty)
            ...
            case "${prev}" in
                ...
                --notification-thumbnail)
                    COMPREPLY=($(compgen -W "screenshot app-icon" -- "${cur}"))
                    return 0
                    ;;
                --action-on-enter)
                    COMPREPLY=($(compgen -W "save-to-clipboard save-to-file save-to-file-as copy-filepath-to-clipboard exit" -- "${cur}"))
